...
public class AlloyForgingTable extends BlockWithEntity implements BlockEntityProvider {
    ...
    public AlloyForgingTable(Settings settings) {
        super(settings);
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new AlloyForgingTableBlockEntity(pos, state);
    }
    ...
    protected void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof AlloyForgingTableBlockEntity) {
                ItemScatterer.spawn(world, pos, (AlloyForgingTableBlockEntity) blockEntity);
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        if (!world.isClient()) {
            NamedScreenHandlerFactory screenHandlerFactory = (AlloyForgingTableBlockEntity) world.getBlockEntity(pos);
    ...
    public @Nullable <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.ALLOY_FORGING_TABLE,
